...
public class HotAdapter extends RecyclerView.Adapter<HotAdapter.ViewHolder> {
    @NonNull
    private HotReceiptFragment mContext;
    private ArrayList<Post> mData;

    public HotAdapter(HotReceiptFragment HotReceiptFragment, ArrayList<Post> data) {
        this.mContext = HotReceiptFragment;
        this.mData = data;
    }
    @Override
    ...
    @Override
    public void onBindViewHolder(@NonNull final HotAdapter.ViewHolder holder, final int position) {
